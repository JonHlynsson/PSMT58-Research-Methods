...
-   Since $\eta_{\text{p}}^{2}$ always carries a positive bias, they could have also reported  $\mathcal{O}^{2}$ Logistic regression - $\Delta{\text{x}^{2}}$ and $OR$.
