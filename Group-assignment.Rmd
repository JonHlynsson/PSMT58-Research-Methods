...
In Wilson's (2018) study 1, the researchers hypothesized that inmates who look less trustworthy were more likely to receive death sentences.
...
sent_new <- sent_new - 1
summary(sent_new) # check if it worked
...
Models <- rbind(Model_1 = model_1_stats, Model_2 = model_2_stats)
...
-   Since partial eta squared always carries a positive bias, they could have also reported Omega squared Logistic regression - $\Delta{\text{x}^{2}}$ and Odds ratio.


-   Odds ratio was used as effect size for the individual predictors tested 

-   CI for Odds ratio was reported
